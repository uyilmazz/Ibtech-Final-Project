...
@WebServlet("/api/carts/findByCustomerName")
public class CartFindByCustomerNameServlet extends HttpServlet {
	@Override
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			if(customerName == null) {
				...
				DataResult<Cart> result = cartService.getByUserName(customerName);
				if(result.isSuccess()) {
